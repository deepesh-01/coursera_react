...
const mapDispatchToProps = (dispatch) =>({
  ...
  postFeedback: (id,firstname,lastname,telnum,email,message) =>
    dispatch(postFeedback(id,firstname,lastname,telnum,email,message)),
          ...
          <CSSTransition key={this.props.location.key} classNames="page" timeout={300}>
            <Switch>
              ...
              <Route exact path ="/about" component={() => <About
                      leaders={this.props.leaders} />}></Route>
